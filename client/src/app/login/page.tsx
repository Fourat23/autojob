...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      // ici on déclenchera l'appel backend plus tard
    }
  };
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          {isRegister && (
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border ${errors.name ? 'border-red-400' : 'border-gray-300'
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border ${errors.email ? 'border-red-400' : 'border-gray-300'
                } rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-300`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="••••••••"
              className={`w-full px-4 py-2 border ${errors.password ? 'border-red-400' : 'border-gray-300'
                } rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-300`}
            />
